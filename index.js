...
app.use(cors({
  credentials: true,
  origin: "https://newton-todos.herokuapp.com"
}));
...
); // adds a property called session to reqs

// connect
const db = mongoose.createConnection("mongodb+srv://PizzaUser:12345@cluster0.rnxiv.mongodb.net/<TodoApp>?retryWrites=true&w=majority", {
